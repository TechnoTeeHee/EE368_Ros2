...
#ifndef LAB_INTERFACES__SRV__DETAIL__MEASURE_WALL_DIST__FUNCTIONS_H_
#define LAB_INTERFACES__SRV__DETAIL__MEASURE_WALL_DIST__FUNCTIONS_H_
...
/// Initialize srv/MeasureWallDist message.
/**
...
/// Finalize srv/MeasureWallDist message.
/**
...
/// Create srv/MeasureWallDist message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lab_interfaces__srv__MeasureWallDist_Request__init().
...
/// Destroy srv/MeasureWallDist message.
/**
 * It calls
 * lab_interfaces__srv__MeasureWallDist_Request__fini()
...
/// Check for srv/MeasureWallDist message equality.
/**
...
/// Copy a srv/MeasureWallDist message.
/**
...
/// Initialize array of srv/MeasureWallDist messages.
/**
...
/// Finalize array of srv/MeasureWallDist messages.
/**
 * It calls
 * lab_interfaces__srv__MeasureWallDist_Request__fini()
...
/// Create array of srv/MeasureWallDist messages.
/**
 * It allocates the memory for the array and calls
 * lab_interfaces__srv__MeasureWallDist_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MeasureWallDist messages.
/**
 * It calls
 * lab_interfaces__srv__MeasureWallDist_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MeasureWallDist message array equality.
/**
...
/// Copy an array of srv/MeasureWallDist messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lab_interfaces__srv__MeasureWallDist_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lab_interfaces
...
/**
 * It calls
 * lab_interfaces__srv__MeasureWallDist_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lab_interfaces
...
/**
 * It allocates the memory for the array and calls
 * lab_interfaces__srv__MeasureWallDist_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lab_interfaces
...
/**
 * It calls
 * lab_interfaces__srv__MeasureWallDist_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LAB_INTERFACES__SRV__DETAIL__MEASURE_WALL_DIST__FUNCTIONS_H_
