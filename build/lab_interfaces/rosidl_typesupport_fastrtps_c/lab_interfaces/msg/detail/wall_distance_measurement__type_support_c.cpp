...
#include "lab_interfaces/msg/detail/wall_distance_measurement__rosidl_typesupport_fastrtps_c.h"
...
using _WallDistanceMeasurement__ros_msg_type = lab_interfaces__msg__WallDistanceMeasurement;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WallDistanceMeasurement__ros_msg_type * ros_message = static_cast<const _WallDistanceMeasurement__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _WallDistanceMeasurement__ros_msg_type * ros_message = static_cast<_WallDistanceMeasurement__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _WallDistanceMeasurement__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lab_interfaces__msg__WallDistanceMeasurement(
...
static size_t _WallDistanceMeasurement__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lab_interfaces__msg__WallDistanceMeasurement(
...
static message_type_support_callbacks_t __callbacks_WallDistanceMeasurement = {
  "lab_interfaces::msg",
...
static rosidl_message_type_support_t _WallDistanceMeasurement__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WallDistanceMeasurement,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab_interfaces, msg, WallDistanceMeasurement)() {
  return &_WallDistanceMeasurement__type_support;
}
