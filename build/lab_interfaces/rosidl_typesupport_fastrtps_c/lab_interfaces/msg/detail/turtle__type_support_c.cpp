...
#include "lab_interfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_c.h"
...
using _Turtle__ros_msg_type = lab_interfaces__msg__Turtle;
...
static uint32_t _Turtle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lab_interfaces__msg__Turtle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lab_interfaces__msg__Turtle;
    is_plain =
      (
...
static size_t _Turtle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lab_interfaces__msg__Turtle(
