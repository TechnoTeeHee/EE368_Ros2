...
#include "lab_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_c.h"
...
size_t max_serialized_size_lab_interfaces__msg__Turtle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab_interfaces, msg, Turtle)();


using _TurtleArray__ros_msg_type = lab_interfaces__msg__TurtleArray;
...
size_t get_serialized_size_lab_interfaces__msg__TurtleArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TurtleArray__ros_msg_type * ros_message = static_cast<const _TurtleArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_lab_interfaces__msg__Turtle(
...
static uint32_t _TurtleArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lab_interfaces__msg__TurtleArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lab_interfaces
size_t max_serialized_size_lab_interfaces__msg__TurtleArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _TurtleArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lab_interfaces__msg__TurtleArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab_interfaces, msg, TurtleArray)() {
