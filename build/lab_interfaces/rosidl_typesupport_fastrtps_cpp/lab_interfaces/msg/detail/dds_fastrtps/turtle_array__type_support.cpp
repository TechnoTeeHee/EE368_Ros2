...
#include "lab_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const lab_interfaces::msg::Turtle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  lab_interfaces::msg::Turtle &);
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        lab_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Turtle(
...
{
  auto typed_message =
    static_cast<const lab_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lab_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &lab_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab_interfaces, msg, TurtleArray)() {
  return &lab_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
