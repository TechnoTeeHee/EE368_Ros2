...
bool lab_interfaces__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lab_interfaces.msg._num.Num", full_classname_dest, 27) == 0);
  }
  lab_interfaces__msg__Num * ros_message = _ros_message;
  {  // name
...
PyObject * lab_interfaces__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lab_interfaces.msg._num");
