...
#include "action_interfaces/action/detail/maze__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // goal_positions
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // goal_positions

// forward declare type support functions


using _Maze_Goal__ros_msg_type = action_interfaces__action__Maze_Goal;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = ros_message->goal_positions.size;
    auto array_ptr = ros_message->goal_positions.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: goal_positions
  {
    ...
    if (ros_message->goal_positions.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->goal_positions);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->goal_positions, size)) {
      fprintf(stderr, "failed to create array for field 'goal_positions'");
      return false;
    }
    auto array_ptr = ros_message->goal_positions.data;
...
size_t get_serialized_size_action_interfaces__action__Maze_Goal(
  const void * untyped_ros_message,
...
static uint32_t _Maze_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__Maze_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__Maze_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = action_interfaces__action__Maze_Goal;
    is_plain =
      (
...
static size_t _Maze_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__Maze_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_Goal)() {
...
using _Maze_Result__ros_msg_type = action_interfaces__action__Maze_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__Maze_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Maze_Result__ros_msg_type * ros_message = static_cast<const _Maze_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__Maze_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__Maze_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__Maze_Result;
    is_plain =
      (
...
static size_t _Maze_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__Maze_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_Result)() {
...
// already included above
// #include "rosidl_runtime_c/primitives_sequence.h"  // current_goal
// already included above
// #include "rosidl_runtime_c/primitives_sequence_functions.h"  // current_goal

// forward declare type support functions


using _Maze_Feedback__ros_msg_type = action_interfaces__action__Maze_Feedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = ros_message->current_goal.size;
    auto array_ptr = ros_message->current_goal.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: current_goal
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->current_goal.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->current_goal);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->current_goal, size)) {
      fprintf(stderr, "failed to create array for field 'current_goal'");
      return false;
    }
    auto array_ptr = ros_message->current_goal.data;
    cdr.deserializeArray(array_ptr, size);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__Maze_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Maze_Feedback__ros_msg_type * ros_message = static_cast<const _Maze_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__Maze_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__Maze_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__Maze_Feedback;
    is_plain =
      (
...
static size_t _Maze_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__Maze_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_Feedback)() {
...
// already included above
// #include "action_interfaces/action/detail/maze__functions.h"  // goal
...
using _Maze_SendGoal_Request__ros_msg_type = action_interfaces__action__Maze_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__Maze_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Maze_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Maze_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_action_interfaces__action__Maze_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__Maze_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__Maze_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_action_interfaces__action__Maze_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__Maze_SendGoal_Request;
    is_plain =
      (
...
static size_t _Maze_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__Maze_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_SendGoal_Request)() {
...
using _Maze_SendGoal_Response__ros_msg_type = action_interfaces__action__Maze_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__Maze_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Maze_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Maze_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__Maze_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__Maze_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__Maze_SendGoal_Response;
    is_plain =
      (
...
static size_t _Maze_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__Maze_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_SendGoal)() {
...
using _Maze_GetResult_Request__ros_msg_type = action_interfaces__action__Maze_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__Maze_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Maze_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Maze_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__Maze_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__Maze_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__Maze_GetResult_Request;
    is_plain =
      (
...
static size_t _Maze_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__Maze_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_GetResult_Request)() {
...
// already included above
// #include "action_interfaces/action/detail/maze__functions.h"  // result
...
using _Maze_GetResult_Response__ros_msg_type = action_interfaces__action__Maze_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__Maze_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Maze_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Maze_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_action_interfaces__action__Maze_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__Maze_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__Maze_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_action_interfaces__action__Maze_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__Maze_GetResult_Response;
    is_plain =
      (
...
static size_t _Maze_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__Maze_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_GetResult)() {
...
// already included above
// #include "action_interfaces/action/detail/maze__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Maze_FeedbackMessage__ros_msg_type = action_interfaces__action__Maze_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__Maze_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Maze_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Maze_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_action_interfaces__action__Maze_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__Maze_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__Maze_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_action_interfaces__action__Maze_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = action_interfaces__action__Maze_FeedbackMessage;
    is_plain =
      (
...
static size_t _Maze_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__Maze_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, Maze_FeedbackMessage)() {
