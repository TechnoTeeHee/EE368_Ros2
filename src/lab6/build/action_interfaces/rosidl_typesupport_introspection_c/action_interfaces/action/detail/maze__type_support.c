...
size_t action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__size_function__Maze_Feedback__current_goal(
  const void * untyped_member)
{
  const rosidl_runtime_c__float__Sequence * member =
    (const rosidl_runtime_c__float__Sequence *)(untyped_member);
...
const void * action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__get_const_function__Maze_Feedback__current_goal(
  const void * untyped_member, size_t index)
{
  const rosidl_runtime_c__float__Sequence * member =
    (const rosidl_runtime_c__float__Sequence *)(untyped_member);
...
void * action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__get_function__Maze_Feedback__current_goal(
  void * untyped_member, size_t index)
{
  rosidl_runtime_c__float__Sequence * member =
    (rosidl_runtime_c__float__Sequence *)(untyped_member);
...
void action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__fetch_function__Maze_Feedback__current_goal(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const float * item =
    ((const float *)
    action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__get_const_function__Maze_Feedback__current_goal(untyped_member, index));
  float * value =
    (float *)(untyped_value);
  *value = *item;
}

void action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__assign_function__Maze_Feedback__current_goal(
  void * untyped_member, size_t index, const void * untyped_value)
{
  float * item =
    ((float *)
    action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__get_function__Maze_Feedback__current_goal(untyped_member, index));
  const float * value =
    (const float *)(untyped_value);
  *item = *value;
}

bool action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__resize_function__Maze_Feedback__current_goal(
  void * untyped_member, size_t size)
{
  rosidl_runtime_c__float__Sequence * member =
    (rosidl_runtime_c__float__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__Maze_Feedback_message_member_array[7] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces__action__Maze_Feedback, current_goal),  // bytes offset in struct
    NULL,  // default value
    action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__size_function__Maze_Feedback__current_goal,  // size() function pointer
    action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__get_const_function__Maze_Feedback__current_goal,  // get_const(index) function pointer
    action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__get_function__Maze_Feedback__current_goal,  // get(index) function pointer
    action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__fetch_function__Maze_Feedback__current_goal,  // fetch(index, &value) function pointer
    action_interfaces__action__Maze_Feedback__rosidl_typesupport_introspection_c__assign_function__Maze_Feedback__current_goal,  // assign(index, value) function pointer
