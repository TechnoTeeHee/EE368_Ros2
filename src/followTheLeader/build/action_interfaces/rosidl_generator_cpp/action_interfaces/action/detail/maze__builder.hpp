...
class Init_Maze_Goal_index
{
public:
  Init_Maze_Goal_index()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::action_interfaces::action::Maze_Goal index(::action_interfaces::action::Maze_Goal::_index_type arg)
  {
...
{
  return action_interfaces::action::builder::Init_Maze_Goal_index();
}
...
class Init_Maze_Result_distance
{
public:
  explicit Init_Maze_Result_distance(::action_interfaces::action::Maze_Result & msg)
  : msg_(msg)
  {}
  ::action_interfaces::action::Maze_Result distance(::action_interfaces::action::Maze_Result::_distance_type arg)
  {
...
class Init_Maze_Result_index
{
public:
  Init_Maze_Result_index()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Maze_Result_distance index(::action_interfaces::action::Maze_Result::_index_type arg)
  {
    msg_.index = std::move(arg);
    return Init_Maze_Result_distance(msg_);
  }
...
{
  return action_interfaces::action::builder::Init_Maze_Result_index();
}
...
class Init_Maze_Feedback_direction
{
public:
  explicit Init_Maze_Feedback_direction(::action_interfaces::action::Maze_Feedback & msg)
  : msg_(msg)
  {}
  ::action_interfaces::action::Maze_Feedback direction(::action_interfaces::action::Maze_Feedback::_direction_type arg)
  {
...
class Init_Maze_Feedback_distance
{
public:
  explicit Init_Maze_Feedback_distance(::action_interfaces::action::Maze_Feedback & msg)
  : msg_(msg)
  {}
  Init_Maze_Feedback_direction distance(::action_interfaces::action::Maze_Feedback::_distance_type arg)
  {
    msg_.distance = std::move(arg);
    return Init_Maze_Feedback_direction(msg_);
  }
...
class Init_Maze_Feedback_index
{
public:
  Init_Maze_Feedback_index()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Maze_Feedback_distance index(::action_interfaces::action::Maze_Feedback::_index_type arg)
  {
    msg_.index = std::move(arg);
    return Init_Maze_Feedback_distance(msg_);
  }
...
{
  return action_interfaces::action::builder::Init_Maze_Feedback_index();
}
