...
#include "lab_interfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lab_interfaces::msg::Turtle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lab_interfaces::msg::Turtle & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lab_interfaces::msg::Turtle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lab_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lab_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &lab_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab_interfaces, msg, Turtle)() {
  return &lab_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
