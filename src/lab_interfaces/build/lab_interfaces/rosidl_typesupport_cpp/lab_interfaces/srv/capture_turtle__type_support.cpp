...
static const _CaptureTurtle_Request_type_support_symbol_names_t _CaptureTurtle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab_interfaces, srv, CaptureTurtle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab_interfaces, srv, CaptureTurtle_Request)),
  }
};
...
{
  return &::lab_interfaces::srv::rosidl_typesupport_cpp::CaptureTurtle_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lab_interfaces, srv, CaptureTurtle_Request)() {
  return get_message_type_support_handle<lab_interfaces::srv::CaptureTurtle_Request>();
}
...
static const _CaptureTurtle_Response_type_support_symbol_names_t _CaptureTurtle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab_interfaces, srv, CaptureTurtle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab_interfaces, srv, CaptureTurtle_Response)),
  }
};
...
{
  return &::lab_interfaces::srv::rosidl_typesupport_cpp::CaptureTurtle_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lab_interfaces, srv, CaptureTurtle_Response)() {
  return get_message_type_support_handle<lab_interfaces::srv::CaptureTurtle_Response>();
}
...
static const _CaptureTurtle_type_support_symbol_names_t _CaptureTurtle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab_interfaces, srv, CaptureTurtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab_interfaces, srv, CaptureTurtle)),
  }
};
...
{
  return &::lab_interfaces::srv::rosidl_typesupport_cpp::CaptureTurtle_service_type_support_handle;
}
