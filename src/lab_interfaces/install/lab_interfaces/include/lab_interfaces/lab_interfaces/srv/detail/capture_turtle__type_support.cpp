...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CaptureTurtle_Response_message_member_array[2] = {
  {
    "status",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lab_interfaces::srv::CaptureTurtle_Response, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lab_interfaces::srv::CaptureTurtle_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
