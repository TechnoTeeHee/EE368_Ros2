...
bool lab_interfaces__msg__turtle_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * lab_interfaces__msg__turtle_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lab_interfaces.msg._turtle_array");
