...
bool lab_interfaces__msg__wall_distance_measurement__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lab_interfaces.msg._wall_distance_measurement.WallDistanceMeasurement", full_classname_dest, 69) == 0);
  }
  lab_interfaces__msg__WallDistanceMeasurement * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of WallDistanceMeasurement */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lab_interfaces.msg._wall_distance_measurement");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WallDistanceMeasurement");
